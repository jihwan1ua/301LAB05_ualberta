...
public class MainActivity extends Activity {
	...
	public void takeAPhoto() {
		...
		// after this step, the below method, onActivityResult will be called and it
		// will receive the requestCode from CAPTURE_IMAGE_ACTIVITY_REQUEST_CODE
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		if(requestCode == CAPTURE_IMAGE_ACTIVITY_REQUEST_CODE){
			if (resultCode == RESULT_OK) {
				// if picture is successfully taken
				...
				// if picture not successfully taken
				TextView tv = (TextView) findViewById(R.id.status);
